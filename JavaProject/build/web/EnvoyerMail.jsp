                    ...
                    <div>
                        ...
                        <thead>
                            <tr>
                                ...
                                <td><center>Envoyer Mail</center></td>
                            </tr>
                            ...
                            <%
                                try {
                                    ...
                                    String qrl = "select a.mail from abonne a JOIN ligne l JOIN facture f where f.payer=0 and l.numLigne=f.numLigne and l.matricule=a.matricule";
